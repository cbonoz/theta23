...
const SponsorSidebar = ({ pageTitle, open, setOpen }) => {
  ...
  return (
    <div>
        ...
        >
            ...
            <Divider />
            <List>
                <ListItem disablePadding onClick={() => {navigate("/sponsor/transactions");}}>
                    <ListItemButton>
                    <ListItemIcon>
                ...
                <ListItem disablePadding onClick={() => {navigate("/sponsor/sponsoredpets");}}>
                    <ListItemButton>
                    <ListItemIcon>
                        <PaidIcon style={{ color: '#424242' }} />
                    </ListItemIcon>
                    <ListItemText primary="Sponsoring Pets" />
                    </ListItemButton>
                </ListItem>

                <ListItem disablePadding onClick={() => {navigate("/sponsor/account");}}>
                    <ListItemButton>
                    <ListItemIcon>
